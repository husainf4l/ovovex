...
class Command(BaseCommand):
    ...
    def create_customers_and_vendors(self):
        ...
        self.stdout.write(
            f"Created {len(customers_data)} customers and {len(vendors_data)} vendors"
        )
    ...
    def create_inventory(self):
        ...
        for cat_name in categories_data:
            InventoryCategory.objects.get_or_create(
                name=cat_name, defaults={"description": f"{cat_name} category"}
            )
        ...
        self.stdout.write(
            f"Created inventory categories and {len(inventory_data)} items"
        )
    ...
    def create_journal_entries(self):
        ...
        for i in range(10):
            ...
            # Get random accounts
            debit_account = random.choice(
                [acc for acc in accounts if acc.account_type in ["ASSET", "EXPENSE"]]
            )
        ...
        notification_data = [
            {
                ...
                "message": "Invoice INV-1005 is 15 days overdue",
                "type": "WARNING",
            },
            {
                "title": "Low Inventory Alert",
                "message": "Printer Paper stock is below reorder point",
                "type": "WARNING",
            },
            {
            ...
            {
                "title": "Budget Alert",
                "message": "Marketing expenses are 85% of budgeted amount",
                "type": "INFO",
            },
            {
                "title": "Tax Filing Due",
                "message": "Quarterly tax return due in 7 days",
                "type": "CRITICAL",
            },
        ]
