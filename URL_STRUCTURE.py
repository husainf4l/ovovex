...
urlpatterns = [
    ...
    path('professional-services/', views.professional_services, name='professional_services'),
    ...
    path('expense-management-feature/', views.expense_management_feature, name='expense_management_feature'),
...
urlpatterns = [
    ...
    path('recurring-invoices/create/', views.recurring_invoice_create, name='recurring_invoice_create'),
    path('recurring-invoices/<int:pk>/', views.recurring_invoice_detail, name='recurring_invoice_detail'),
    
    # Quotes & Estimates
    path('quotes/', views.quote_list, name='quote_list'),
    path('quotes/create/', views.quote_create, name='quote_create'),
    path('quotes/<int:pk>/', views.quote_detail, name='quote_detail'),
    path('quotes/<int:pk>/convert/', views.quote_convert_to_invoice, name='quote_convert'),
    ...
    path('payment-links/create/', views.payment_link_create, name='payment_link_create'),
    path('payment-links/<uuid:uuid>/', views.payment_link_public, name='payment_link_public'),
]
...
urlpatterns = [
    ...
    path('collections/send-reminders/', views.send_collection_reminders, name='send_reminders'),
]
...
urlpatterns = [
    ...
    path('depreciation/calculate/', views.depreciation_calculate, name='depreciation_calculate'),
...
urlpatterns = [
    ...
    path('expenses/bulk-approve/', views.expense_bulk_approve, name='expense_bulk_approve'),
...
urlpatterns = [
    ...
    path('reports/<str:report_type>/export/', views.report_export, name='report_export'),
]
...
urlpatterns = [
    ...
    path('recommendations/<int:pk>/apply/', views.recommendation_apply, name='recommendation_apply'),
...
urlpatterns = [
    ...
    path('scheduled-reports/create/', views.scheduled_report_create, name='scheduled_report_create'),
]
...
urlpatterns = [
    ...
    path('payment-processors/<str:provider>/connect/', views.payment_processor_connect, name='payment_processor_connect'),
    
    # E-commerce
    path('ecommerce/', views.ecommerce_integrations, name='ecommerce'),
    path('ecommerce/<str:platform>/connect/', views.ecommerce_connect, name='ecommerce_connect'),
